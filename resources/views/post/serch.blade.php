        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mx-4 sm:p-8">
                <form method="post" action="/result" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-8 mb-2 mx-auto flex flex-col md:flex-row justify-center">
                        <div class="w-1/4 font-medium">
                                単語で検索：<br>  
                        </div>
                        <div class="w-3/4">
                            <div class="md:flex items-center mt-4">
                                <input type="text" name="word" class="w-full py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="word" value="{{old('word')}}" placeholder="例)遊具,公園">
                            </div>
                            <div>
                                （複数可：カンマもしくはスペースで区切って下さい）
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="mt-8 mb-2 flex flex-col md:flex-row justify-center">
                        <div class="w-1/4 font-medium">
                            施設区分：
                        </div>
                        <div class="w-3/4">
                    ...
                    <div class="mt-8 mb-2 text-center">
                        <x-primary-button class="bg-blue-800 w-24 md:w-48 mt-4 flex items-center justify-center">
                            <span>検索</span>
                        </x-primary-button>
                    </div>
